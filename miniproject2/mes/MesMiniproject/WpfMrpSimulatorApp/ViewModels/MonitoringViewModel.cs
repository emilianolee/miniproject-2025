...
namespace WpfMrpSimulatorApp.ViewModels
{
    public partial class MonitoringViewModel : ObservableObject
    {
        ...
        private string mqttSubTopic;    // MQTT메시지 받아올 때 쓰는 토픽
        private string mqttPubTopic;    // MQTT메시지 보낼 때 쓰는 토픽
        ...
        public MonitoringViewModel(IDialogCoordinator coordinator)
        {
            ...
            // MQTT 초기화
            brokerHost = "210.119.12.59";   // 본인 아이피
            clientId = "MON00";
            mqttSubTopic = "pknu/sf59/data";
            mqttPubTopic = "pknu/sf59/control";
        ...
        public async Task StartProcess()
        {
            try
            {
                ...
                var paylaod = JsonConvert.SerializeObject(prcMsg, Formatting.Indented);
